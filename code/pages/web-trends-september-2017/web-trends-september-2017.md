...
This second episode in *Web Trends* presents a few techniques marking this milestone.
...
The new typefaces of the last few years are immersive. Set to adaptively take the whole screen; wrapped into a marquee; repeated all over again on scrolling; doing the magic on hover; equipped with smart features&mdash;well set text now tells more than thousands of images.
